...
public class RequestsView extends VerticalLayout {
    ...
    public RequestsView(CreativeRequestRepository repo, ClientRepository clientRepo) {
        this.repo = repo;
